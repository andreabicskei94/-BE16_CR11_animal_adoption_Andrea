    ...
    if($nOR == 0) {
        ...
        foreach($rows as $val) {
            ...
            <div class="card-body">
              ...
              <a href="show.php?id='.$val["id"].'" class="m-1 btn  btn-outline-success">Show More Details</a>
              <a href="adopt.php?id='.$val["id"].'" class="m-1 btn btn-outline-dark">Take Me Home</a>
            </div>
            </div>
            </div>
          </div>
...
<div class="container">
    ...
    <h2 class="text-center m-5">Our Pets</h2>
    <div class="row">
    <?= $body ?>
